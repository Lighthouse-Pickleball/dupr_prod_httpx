...
class AuthenticationApi:
    ...
    async def login_using_post(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SingleWrapperOfTokenResponse",
            '403': None,
        }
    ...
    @validate_call
    async def login_using_post_with_http_info(
        self,
        version: Annotated[StrictStr, Field(description="version")],
        x_authorization: Annotated[StrictStr, Field(description="x-authorization")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SingleWrapperOfTokenResponse]:
        """Generate Access Token
    ...
    @validate_call
    async def login_using_post_without_preload_content(
        self,
        version: Annotated[StrictStr, Field(description="version")],
        x_authorization: Annotated[StrictStr, Field(description="x-authorization")],
        _request_timeout: Union[
    ...
    def _login_using_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/auth/{version}/token',

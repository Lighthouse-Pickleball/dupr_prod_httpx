...
class ExternalAgeRangeFilter(BaseModel):
    """
    ExternalAgeRangeFilter
    """ # noqa: E501
    max: StrictInt = Field(description="Maximum age value of a user")
    min: StrictInt = Field(description="Minimum age value of a user")

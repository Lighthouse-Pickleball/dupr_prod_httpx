...
class ExternalUserDetailResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["firstName", "fullName", "id", "lastName", "performance", "ratings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "performance": ExternalUserPerformance.from_dict(obj["performance"]) if obj.get("performance") is not None else None,

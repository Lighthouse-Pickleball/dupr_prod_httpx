...
class ArrayWrapperOfPlayerResponse(BaseModel):
    """
    ArrayWrapperOfPlayerResponse
    """ # noqa: E501
    message: Optional[StrictStr] = None
    results: Optional[List[PlayerResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [PlayerResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

...
class ExternalDeleteMatchRequest(BaseModel):
    """
    ExternalDeleteMatchRequest
    """ # noqa: E501
    identifier: StrictStr = Field(description="An unique identifier for this match")
    match_code: StrictStr = Field(description="An unique match code returned at time of creation", alias="matchCode")
    __properties: ClassVar[List[str]] = ["identifier", "matchCode"]
